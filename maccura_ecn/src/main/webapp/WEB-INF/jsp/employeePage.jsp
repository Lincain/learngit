...
<body>
<div class="hrms_emp_container">
    <!-- 导航栏-->
    <%@ include file="./common/head.jsp"%>


    <!-- 中间部分（左侧栏+表格内容） -->
    <div class="hrms_emp_body">
        <!-- 左侧栏 -->
            ...
            <div class="panel panel-success
                ...
                <div class="panel-body">
                    ...
                    <nav aria-label="Page navigation" class="pull-right">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/emp/getEmpList?pageNo=1">首页</a></li>
                            ...
                            <c:forEach begin="1" end="${totalPages<5?totalPages:5}" step="1" var="itemPage">
                                <c:if test="${curPageNo == itemPage}">
                                    <li class="active"><a href="${pageContext.request.contextPath}/emp/getEmpList?pageNo=${itemPage}">${itemPage}</a></li>
                                </c:if>
                                <c:if test="${curPageNo != itemPage}">
                                    <li><a href="${pageContext.request.contextPath}/emp/getEmpList?pageNo=${itemPage}">${itemPage}</a></li>
                                </c:if>
                            </c:forEach>
                            ...
                            <li><a href="${pageContext.request.contextPath}/emp/getEmpList?pageNo=${totalPages}">尾页</a></li>
                        </ul>
                    </nav>
                </div>
...
<script type="text/javascript">
    ...
    $(".prePage").click(function () {
         if (curPageNo > 1){
             ...
             $(this).attr("href", "${pageContext.request.contextPath}/emp/getEmpList?pageNo="+pageNo);
         }
    });
    //下一页
