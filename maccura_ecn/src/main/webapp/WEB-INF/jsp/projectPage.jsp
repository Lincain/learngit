...
<body>
<div class="hrms_pro_container">
    <!-- 导航栏-->
    <%@ include file="./common/head.jsp"%>


    <!-- 中间部分（左侧栏+表格内容） -->
    <div class="hrms_pro_body">
        <!-- 左侧栏 -->
        <%@ include file="./common/leftsidebar.jsp"%>

        <!-- 部门表格内容 -->
        <div class="pro_info col-sm-10">
            <div class="panel panel-success">
                ...
                <!-- Table -->
                <table class="table table-bordered table-hover" id="pro_table">
                    <thead>
                    	<th>序号</th>
                        <th>项目编号</th>
                        <th>项目名称</th>
                ...
                <div class="panel-body">
                    ...
                    <nav aria-label="Page navigation" class="pull-right">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/pro/getProList?pageNo=1">首页</a></li>
                            ...
                            <c:forEach begin="1" end="${totalPages<5?totalPages:5}" step="1" var="itemPage">
                                <c:if test="${curPageNo == itemPage}">
                                    <li class="active"><a href="${pageContext.request.contextPath}/pro/getProList?pageNo=${itemPage}">${itemPage}</a></li>
                                </c:if>
                                <c:if test="${curPageNo != itemPage}">
                                    <li><a href="${pageContext.request.contextPath}/pro/getProList?pageNo=${itemPage}">${itemPage}</a></li>
                                </c:if>
                            </c:forEach>
                            ...
                            <li><a href="${pageContext.request.contextPath}/pro/getProList?pageNo=${totalPages}">尾页</a></li>
                        </ul>
                    </nav>
                </div>
...
<script type="text/javascript">
    ...
    $(".prePage").click(function () {
         if (curPageNo > 1){
             ...
             $(this).attr("href", "${pageContext.request.contextPath}/pro/getProList?pageNo="+pageNo);
         }
    });
    //下一页
